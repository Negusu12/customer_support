  ...
  <div class="row">
    ...
    <div class="col-12 col-sm-6 col-md-3">
      <div class="info-box mb-3">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php echo $conn->query("SELECT * FROM tickets WHERE (tickets.status = 0 OR tickets.status = 1) AND tickets.customer_id = {$_SESSION['login_id']}")->num_rows; ?></span>
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
      <div class="info-box mb-3">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number"><?php echo $conn->query("SELECT * FROM tickets where tickets.status=2 and tickets.customer_id = {$_SESSION['login_id']}")->num_rows; ?></span>
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
    ...
    <div class="col-12 col-sm-6 col-md-3">
      <div class="info-box mb-3">
        ...
        <div class="info-box-content">
          <span class="info-box-text">Total Tickets</span>
          <span class="info-box-number"><?php echo $conn->query("SELECT * FROM tickets where tickets.customer_id = {$_SESSION['login_id']}")->num_rows; ?></span>
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
